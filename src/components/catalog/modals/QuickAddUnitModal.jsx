...
const QuickAddUnitModal = ({ open, onCancel, onSave, loading }) => {
      ...
      >
        ...
        >
          <div style={{ fontSize: 14, fontWeight: 700, color: '#0f172a', display: 'flex', alignItems: 'center', gap: 6 }}>
            <AppstoreOutlined style={{ color: '#ea580c' }} /> Tạo đơn vị tính mới
          </div>
          <button
            onClick={onCancel}
        ...
        <form onSubmit={handleSubmit} style={{ padding: 16 }}>
          <div style={{ marginBottom: 14 }}>
            ...
            <input
              type="text"
              required
              placeholder="Nhập đơn vị tính (ví dụ: Ly, Chai, Hộp, Kg)"
              value={name}
