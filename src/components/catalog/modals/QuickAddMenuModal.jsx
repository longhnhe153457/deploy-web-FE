...
const QuickAddMenuModal = ({ open, onCancel, onSave, loading }) => {
      ...
      >
        ...
        >
          <div style={{ fontSize: 14, fontWeight: 700, color: '#0f172a', display: 'flex', alignItems: 'center', gap: 6 }}>
            <BookOutlined style={{ color: '#ea580c' }} /> Tạo thực đơn mới
          </div>
          <button
            onClick={onCancel}
        ...
        <form onSubmit={handleSubmit} style={{ padding: 16 }}>
          <div style={{ marginBottom: 14 }}>
            ...
            <input
              type="text"
              required
              placeholder="Nhập tên thực đơn (ví dụ: Thực đơn Sáng, Combo Trưa)"
              value={name}
...
export default QuickAddMenuModal;
